...
void dimuon_macro_forEM_globalchi2_pol4()
{
    TH1::SetDefaultSumw2();
    ...
    // Step 4: Yield Calculation and Significance (GlobalChi2 version)
    ...
    if (outfile_PeakFit && !outfile_PeakFit->IsZombie()) {
        ...
        Significance_GlobalChi2_pol4(outfile_PeakFit);
...
int main()
{
    dimuon_macro_forEM_globalchi2_pol4();
    return 0;
}
