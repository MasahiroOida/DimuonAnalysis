...
void dimuon_macro_forEM_MCHnCluster()
{
    TH1::SetDefaultSumw2();
    ...
    // Step 3: Peak Fitting with Crystal Ball and pol4 background
    ...
    // Step 4: Yield Calculation and Significance (MCHnCluster specific)
    ...
    if (outfile_PeakFit && !outfile_PeakFit->IsZombie()) {
        ...
        Significance_MCHnCluster(outfile_PeakFit); // Use the new MCHnCluster significance script
...
int main()
{
    dimuon_macro_forEM_MCHnCluster();
    return 0;
}
